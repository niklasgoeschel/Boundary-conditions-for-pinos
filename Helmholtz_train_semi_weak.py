...
with open('boundary-conditions-for-pinos-code/results_Helmholtz/semi_weak/losses_errors.npy', 'wb') as f:
    np.save(f, np.array(losses))
    np.save(f, np.array(errors))

with open('boundary-conditions-for-pinos-code/results_Helmholtz/semi_weak/runtime.npy', 'wb') as f:
    np.save(f, end_time-start_time)

torch.save(model, 'boundary-conditions-for-pinos-code/results_Helmholtz/semi_weak/net.pt')