...
model = torch.load('boundary-conditions-for-pinos-code/results_Navier_stokes_different_nu/generalized_local_solution_structure/net.pt', weights_only=False).cuda()
