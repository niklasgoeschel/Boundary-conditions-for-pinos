...
def table_data(method):
    with open('boundary-conditions-for-pinos-code/results_Darcy_flow/operator_training/'+method+'/runtime.npy', 'rb') as f:
    ...
    model = torch.load('boundary-conditions-for-pinos-code/results_Darcy_flow/operator_training/'+method+'/ckp_2/net.pt', weights_only=False)
    total_params = sum(p.numel() for p in model.parameters())

    ckp_size = os.path.getsize('boundary-conditions-for-pinos-code/results_Darcy_flow/operator_training/'+method+'/ckp_2/net.pt')
