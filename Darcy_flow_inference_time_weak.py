...
model = torch.load('boundary-conditions-for-pinos-code/results_Darcy_flow/operator_training/weak/ckp_2/net.pt', weights_only=False)
...
print("Inference time (weak): ", np.mean(inference_times[1::]))