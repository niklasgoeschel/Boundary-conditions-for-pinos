...
with open('boundary-conditions-for-pinos-code/results_Navier_stokes_different_nu/orthogonal_projections/losses_errors.npy', 'wb') as f:
    np.save(f, np.array(losses))
    np.save(f, np.array(errors_u))
    np.save(f, np.array(errors_v))
    np.save(f, np.array(errors_p))

with open('boundary-conditions-for-pinos-code/results_Navier_stokes_different_nu/orthogonal_projections/runtime.npy', 'wb') as f:
    np.save(f, end_time-start_time)

torch.save(model, 'boundary-conditions-for-pinos-code/results_Navier_stokes_different_nu/orthogonal_projections/net.pt')